 ...
 */
//GETTING DATA 
class PLAYER_UNSODED {
   String NAME,DEPARTMENT_NAME,CATEGORY,EMAIL;
    int PROPOSAL_PRICE,TOTAL_RUN,TOTAL_MATCH,TOTAL_WICKET,AVG_RUN;
    byte[]IMAGE;
    public  PLAYER_UNSODED(String NAME,String DEPARTMENT_NAME,String CATEGORY ,int  PROPOSAL_PRICE,String EMAIL,byte[]IMAGE,int TOTAL_RUN,int TOTAL_MATCH ,int TOTAL_WICKET,int AVG_RUN  )
    {
